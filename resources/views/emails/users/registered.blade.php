    ...
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#313131" border="0" cellspacing="0" cellpadding="0" align="center" class="full" >
              ...
              <tr>
                <td align="center" style="font:700 27px 'Open Sans', Arial, Helvetica, sans-serif; color:#ffffff;" class="smallfont"><singleline>Sikeres regisztráció</singleline></td>
              </tr>
            <tr>
                <td height="5"></td>
            </tr>
            <tr>
                <td style="font:14px/19px Arial, Helvetica, sans-serif; color:#ffffff; text-align:center;"><singleline>A könnyebb és gyorsabb rendelés érdekében érdemes kitöltened az adatokat a profilodban.</singleline></td>
            </tr>   
              
            <tr>
                <td  style="text-align:center;">  <a href="http://teaimadok.hu/profile" style="font:bold 14px/19px Arial, Helvetica, sans-serif; color:#ffffff;" >Profil</a></td>
            </tr>   
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="full">
  <tr>
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" height="200" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff;">
                    <tr>
                      <td height="50">&nbsp;</td>
                    </tr>
            </table></td>
